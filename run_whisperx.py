...
def parse_args():
    ...
    ap.add_argument(
        "--initial-prompt-file", default=None, help="Short context prompt for first windowShort context prompt for first windowShort context prompt for first windowShort context prompt for first window",
    )
    ap.add_argument(
