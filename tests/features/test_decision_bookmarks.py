...
def test_bookmark_creation_and_resolution() -> None:
...
def test_promote_bookmark_to_task_and_roll_forward() -> None:
    workflow = DecisionBookmarkingWorkflow()
...
def test_promoting_unknown_bookmark_raises_error() -> None:
    workflow = DecisionBookmarkingWorkflow()
