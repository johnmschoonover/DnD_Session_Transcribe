...
def test_flag_segments_returns_priority_items() -> None:
...
def test_retranscription_queue_tracks_attempts_and_corrections() -> None:
...
def test_mark_attempt_raises_for_unknown_segment() -> None:
    queue = RetranscriptionQueue()
